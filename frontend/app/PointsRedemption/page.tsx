...
const PointsRedemption: React.FC<PointsRedemptionProps> = ({ points, onRedeemSuccess }) => {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gradient-to-r from-blue-200 to-green-200">
      <div className="p-8 max-w-md mx-auto bg-white rounded-lg shadow-lg text-center transition-transform transform hover:scale-105">
        <h3 className="text-3xl font-bold mb-4 text-gray-800">Redeem Your Points</h3>
        <p className="text-lg text-gray-600 mb-6">
          You have <span className="font-semibold text-blue-500">{points}</span> points.
        </p>
        ...
        <button
          ...
          className={`px-6 py-2 rounded-lg text-white ${
            redeemPoints > 0 && redeemPoints <= points && phoneNumber ? 'bg-blue-600 hover:bg-blue-700' : 'bg-blue-600 cursor-not-allowed'
